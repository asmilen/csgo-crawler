...
class SkinDB(DeclarativeBase):
    ...
    price_fn_st = Column('price_fn_st', Integer)
    price_mw_st = Column('price_mw_st', Integer)
    price_ft_st = Column('price_ft_st', Integer)
    price_ww_st = Column('price_ww_st', Integer)
    price_bs_st = Column('price_bs_st', Integer)
